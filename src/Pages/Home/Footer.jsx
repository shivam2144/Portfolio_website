      ...
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/share/pjXH7XPzdcF36n67/?mibextid=qi2Omg"
            ...
            <li>
              <a
                href="https://www.instagram.com/mr_shiv_dalve2144/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/shivam-dalve-607998292"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
